...
| `vae_orig_full_htr03_30k` (진행중 s26k) | full | L1+htr 0.3 | 0.01178 / 0.9243 | 0.00322 |
...
- **htr 은 예산을 30k 로 늘려도 열위**(0.01178, 영어도 0.0032) → 위 「HTR off」 결론 재확인.
- **실제로 듣는 레버는 예산**: 동일 pure-L1 계열에서 15k 0.00713 → 28~30k 0.0065 로 내려간다.
