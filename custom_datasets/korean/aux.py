...
렌더 파이프라인/샘플러는 custom_datasets.korean.split.make_dataset(KoreanSplitFontSquare) 재사용.
알파벳은 custom_datasets.korean.alphabet(코퍼스 기반, latin 인덱스 pretrained 보존).
"""
...
from custom_datasets.korean.split import make_dataset
