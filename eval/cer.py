...
사용: CUDA_VISIBLE_DEVICES=2 python eval/cer.py --ckpt <ckpt> --n 100 [--english] --out _val/cer.txt
"""
...
def main():
    ...
    ap.add_argument("--ocr-gpu", action=argparse.BooleanOptionalAction, default=False, help="OCR 를 GPU 로(기본 CPU, 학습과 GPU 경합 회피)")
    ...
    args = _cfgloader.parse_args(ap, default_config=str(HERE / "configs/eval.yaml"), scopes=('common', 'cer'))
