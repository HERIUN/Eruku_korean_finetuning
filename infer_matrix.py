...
infer_show 는 '행=writer, 열=cfg' 라 한 번에 한 종류 텍스트만 본다.
infer_matrix 는 '행=writer(다양한 style/폰트) × 열=다양한 gen_text' 로,
...
사용:
  CUDA_VISIBLE_DEVICES=2 python infer_matrix.py --ckpt <ckpt> --n-writers 5 --cfg 1.0 \
