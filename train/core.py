...
def _load_or_build_val_samples(args, out_dir, val_fonts=None):
    ...
    """
    from custom_datasets.korean.split import make_dataset as _mk, make_english_dataset as _mken
...
def train(args):
    ...
    if args.online_split:
        from custom_datasets.korean.split import make_dataset, split_collate, dump_samples
        ...
        if args.english_frac > 0:
            from custom_datasets.korean.split import make_english_dataset
    ...
    if args.online_split and args.val_every > 0:
        from custom_datasets.korean.split import dump_samples
