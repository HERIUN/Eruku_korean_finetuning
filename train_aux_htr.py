...
결과는 `save_pretrained(out/htr_sXXXX)` → train_vae_korean.py 가 `HTR.from_pretrained` 로 로드.

예:
  python train_aux_htr.py --out finetune_runs/aux_htr_ko --max-steps 20000 --batch-size 64 --lr 1e-4
"""
