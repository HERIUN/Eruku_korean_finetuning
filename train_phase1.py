...
virtual batch 256 = batch 128 × grad-accum 2,  lr 1e-4,  65000 step.
  ...
  python train_phase1.py                 # 기본 (GPU 는 CUDA_VISIBLE_DEVICES 로 지정)
  CUDA_VISIBLE_DEVICES=2 python train_phase1.py
  python train_phase1.py --max-steps 20000   # 개별 인자 덮어쓰기 가능
