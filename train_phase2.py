...
virtual batch 256 = batch 2 × grad-accum 128,  lr 1e-4,  +5000 step.
  ...
  python train_phase2.py                 # Phase1 의 checkpoint_last.pth 에서 resume
  CUDA_VISIBLE_DEVICES=2 python train_phase2.py
  python train_phase2.py --resume finetune_runs/korean_p1/checkpoint_step_065000.pth
